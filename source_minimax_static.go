	...
	for _, model := range models {
		...
		for _, offering := range model.offerings {
			...
			fragment.Offerings = append(fragment.Offerings, Offering{
				...
				Exposures:   []OfferingExposure{{APIType: APITypeAnthropicMessages, ExposedCapabilities: &Capabilities{Caching: &CachingCapability{Available: true, Mode: CachingModeExplicit, Configurable: true, TopLevelRequestCaching: true}}}},
